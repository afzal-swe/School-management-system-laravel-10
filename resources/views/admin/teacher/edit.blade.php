                ...
                <div class="">
                  <div class="page-title">
                    <div class="title_left">
                      <h3>Teacher Information Update</h3>
                    </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel">
                        ...
                        <div class="x_content">
                          ...
                          <form class="form-horizontal form-label-left" action="{{ route('teacher.update',$edit->id) }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="stu_id" class="form-control col-md-7 col-xs-12" name="t_id" value="{{ $edit->t_id }}">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Date of Birth <span class="text-danger">*</span></label>

                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel">
                        ...
                        <div class="x_content">
                          ...
                          <form class="form-horizontal form-label-left" action="{{ route('class.update',$edit->id) }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="class" class="form-control col-md-7 col-xs-12" name="class" value="{{ $edit->class }}">

                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel">
                        ...
                        <div class="x_content">
                          ...
                          <form class="form-horizontal form-label-left" action="{{ route('notice.update',$edit->id) }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="date" id="date" class="form-control col-md-7 col-xs-12" name="date" value="{{ $edit->date }}">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea name="details" id=""   rows="4" >{!! $edit->details !!}</textarea>
